                    ...
                    <div class="card-body">
                        ...
                        <form id="filter-form">
                            @php
                                ...
                                $sizes = \App\Models\Product::distinct()->pluck('size')->toArray(); // Récupérer les tailles distinctes
                                $grams = \App\Models\Product::distinct()->pluck('grams')->toArray(); // Récupérer les grammes distincts
                            @endphp
                            <!-- Filtre de catégorie -->
                            ...
                            <div class="form-group">
                                ...
                                @foreach ($grams as $gram)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="grams[]"
                                            id="grams_{{ $gram }}" value="{{ $gram }}">
                                        <label class="form-check-label"
                                            for="grams_{{ $gram }}">{{ $gram }}</label>
                                    </div>
                                @endforeach
                            </div>
